...
export const Footer = () => (
  <div className={'mt-12'}>
    ...
    <footer className="bg-footer-25">
      <div className="flex items-center font-medium justify-center container py-8 px-4 md:px-8 text-base text-on-footer">
        Created by&nbsp;
        <a
          href="https://twitter.com/tweetaudun"
          target="_blank"
          className="font-medium hover:bg-types-100 hover:text-white bg-types-75 rounded-lg px-3 py-2 animate"
        >
